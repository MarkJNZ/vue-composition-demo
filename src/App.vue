  ...
  <div id="app">
    <div class="form">
      ...
      <button class="submit" @click="submit">
        {{ dictionary.signupLabel }}
      </button>
    </div>
    <div class="language-container">
      <label for="language">{{ dictionary.languageLabel }}: </label>
      <input v-model="language" type="radio" name="language" value="en" />English
      <input v-model="language" type="radio" name="language" value="es" />Español
    </div>
  </div>
</template>
